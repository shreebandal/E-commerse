...
<?php
    ...
    move_uploaded_file($temp,"feedback/".$emailid.$imgname);

    $query = "INSERT INTO feedback (email,feebacktype,feedbackmsg,feedbackpic) VALUES('$emailid','$feebacktype','$feedbackmsg','$emailid$imgname')";
...
<output>
      <div class="card-body">
      <h4 class="card-title mb-12">Feedback</h4>
      <form action="feedback.php" method="post" onsubmit="return validate()" enctype="multipart/form-data">
		...
		<button class="btn btn-primary btn-block" type="submit" name="register" value="submit">Send</button>
      </form>
      </div> <!-- card-body.// -->
</output>
